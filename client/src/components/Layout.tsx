...
export function Layout({ left, right }: { left: ReactNode; right: ReactNode }) {
  return (
    <div className="flex h-screen flex-col bg-gray-100 text-gray-900">
      <header className="flex items-center gap-4 border-b border-gray-200 bg-white px-6 py-2.5">
        <h1 className="text-base font-bold">Pricelist OCR</h1>
        <span className="text-xs text-gray-400">Upload PDF, OCR pages, view markdown</span>
      </header>
